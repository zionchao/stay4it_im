...
public class Attachment implements Serializable{
    ...
    public enum AttachmentType {
        PNG("image/png", "png"), TIFF("image/tiff", "tiff"), GIF("image/gif", "gif"), JPG("image/jpg", "jpg"), JPEG("image/jpeg", "jpg"), TXT(
                ...
                "application/pdf", "pdf"), DOC("application/msword", "doc"), XLS("application/vnd.ms-excel", "xls"), PPT("application/vnd.ms-powerpoint", "ppt"), PPTX(
                "application/vnd.openxmlformats-officedocument.presentationml.presentation", "pptx"), XLSX(
